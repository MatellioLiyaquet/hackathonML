...
module.exports = ".header-actions {\n  padding-right: 20px;\n}\n.header-actions .avatar {\n  height: 36px;\n  margin-right: 12px;\n}\n.header-actions .user {\n  line-height: 60px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(twitter, snotifyService, db) {
        var _this = this;
        ...
        this.gridData = [];
        db.list('tweets').valueChanges().subscribe(function (resp) {
            _this.tweetData = resp;
    ...
    AppComponent.prototype.getFileData = function () {
        var _this = this;
        this.loading = true;
        this.twitter.isDataAvailable().subscribe(function (resp) {
            if (resp.body) {
                _this.isDataAvailable = resp.body.isAvailable;
                if (_this.isDataAvailable) {
                    resp.body.data.forEach(function (element, index) {
                        if (index !== 0) {
                            var sentiment = '';
                            switch (element[0]) {
                                case '5':
                    ...
                    _this.snotifyService.info("Ready to Upload Data, Please Upload a Valid CSV");
                    _this.loading = false;
                }
            }
        });
    };
    AppComponent.prototype.setValue = function (tweet) {
        var _this = this;
        this.loading = true;
        var req = {
            tweet: tweet
        };
        this.twitter.getTweetSentiment(tweet).subscribe(function (resp) {
            console.log(resp);
            if (resp.body) {
                _this.result = resp.body.result;
                _this.tweetSentiment = resp.body.sentiment;
            }
            else {
                _this.result = "Cannot Analayze";
            }
            _this.loading = false;
            _this.opened = true;
        }, function (err) {
            console.log(err);
            _this.result = err.error.text;
            _this.loading = false;
            _this.opened = true;
        });
    };
    ...
    AppComponent.prototype.uploadFileOnServer = function () {
        var _this = this;
        this.loading = true;
        var formData = new FormData();
        formData.append('file', this.csvFile);
        this.opened1 = false;
        this.twitter.uploadCsv(formData).subscribe(function (resp) {
            if (resp.body.data) {
                _this.csvModel = null;
                _this.opened1 = false;
                _this.snotifyService.success('Uploaded Successfully');
                _this.getFileData();
            }
            else {
                _this.snotifyService.error(resp.body.error);
                _this.csvModel = null;
                _this.opened1 = false;
            }
            _this.loading = false;
    ...
    AppComponent.prototype.addTweet = function (tweet) {
        var _this = this;
        var req = {
        ...
        this.tweet = null;
        this.twitter.addTweet(req).subscribe(function (resp) {
            _this.snotifyService.info('Tweet Added Successfully');
        });
    };
    AppComponent.prototype.trainModel = function () {
        var _this = this;
        this.loading = true;
        this.twitter.trainModel().subscribe(function (resp) {
            if (resp.body) {
                _this.modelTrained = resp.body.trained;
                _this.modelTrainedReason = resp.body.reason;
                _this.loading = false;
                _this.snotifyService.success('Training Done');
            }
        });
    };
    AppComponent.prototype.visualize = function () {
        var _this = this;
        var bs1 = this.twitter.chart1();
        var bs2 = this.twitter.chart2();
        var bs3 = this.twitter.chart3();
        var bs4 = this.twitter.chart4();
        var bs5 = this.twitter.chart5();
        this.loading = true;
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(bs1).subscribe(function (resp) {
            _this.chart1 = 'data:image/jpeg;base64,' + resp[0].body.data;
            _this.loading = false;
        });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(bs2).subscribe(function (resp) {
            _this.chart2 = 'data:image/jpeg;base64,' + resp[0].body.data;
            _this.loading = false;
        });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(bs3).subscribe(function (resp) {
            _this.chart3 = 'data:image/jpeg;base64,' + resp[0].body.data;
            _this.loading = false;
        });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(bs4).subscribe(function (resp) {
            _this.chart4 = 'data:image/jpeg;base64,' + resp[0].body.data;
            _this.loading = false;
        });
        Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["forkJoin"])(bs5).subscribe(function (resp) {
            _this.chart5 = 'data:image/jpeg;base64,' + resp[0].body.data;
            _this.loading = false;
        });
    };
    AppComponent.ctorParameters = function () { return [
        { type: _twitter_service__WEBPACK_IMPORTED_MODULE_2__["TwitterService"] },
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            providers: [_twitter_service__WEBPACK_IMPORTED_MODULE_2__["TwitterService"]],
...
/* harmony import */ var _tweet_tweet_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tweet/tweet.component */ "./src/app/tweet/tweet.component.ts");
/* harmony import */ var _tweets_tweets_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./tweets/tweets.component */ "./src/app/tweets/tweets.component.ts");
/* harmony import */ var _tweet_pipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./tweet.pipe */ "./src/app/tweet.pipe.ts");
...
var firebaseConfig = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_13__["environment"].firebaseConfig;
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _tweet_tweet_component__WEBPACK_IMPORTED_MODULE_8__["TweetComponent"],
                _tweets_tweets_component__WEBPACK_IMPORTED_MODULE_9__["TweetsComponent"],
                _tweet_pipe__WEBPACK_IMPORTED_MODULE_10__["TweetPipe"],
            ],
            imports: [
                ...
                ng_snotify__WEBPACK_IMPORTED_MODULE_12__["SnotifyModule"],
                angularfire2__WEBPACK_IMPORTED_MODULE_14__["AngularFireModule"].initializeApp(firebaseConfig),
                angularfire2_database__WEBPACK_IMPORTED_MODULE_15__["AngularFireDatabaseModule"]
            ],
            providers: [{ provide: 'SnotifyToastConfig', useValue: ng_snotify__WEBPACK_IMPORTED_MODULE_12__["ToastDefaults"] },
                ng_snotify__WEBPACK_IMPORTED_MODULE_12__["SnotifyService"]],
...
/***/ "./src/app/tweet.pipe.ts":
/*!*******************************!*\
  !*** ./src/app/tweet.pipe.ts ***!
  \*******************************/
/*! exports provided: TweetPipe */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TweetPipe", function() { return TweetPipe; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var TweetPipe = /** @class */ (function () {
    ...
    TweetPipe.prototype.transform = function (tweet, args) {
        var text = this.sanitizer.sanitize(_angular_core__WEBPACK_IMPORTED_MODULE_1__["SecurityContext"].NONE, tweet.full_text);
    ...
    TweetPipe.ctorParameters = function () { return [
        { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"] }
    ]; };
    TweetPipe = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = ".card-header {\n  padding: 0;\n}\n.card-header .retweeted {\n  font-size: 0.5rem;\n  font-style: italic;\n}\n.card-header .card-header-actions {\n  float: right;\n}\n.card-block {\n  display: grid;\n  grid-template-columns: 1fr 300px;\n  grid-template-rows: 1fr;\n  grid-template-areas: \"text photo\";\n}\n.card-img {\n  grid-area: photo;\n  text-align: right;\n}\n.card-img img {\n  display: inline-block;\n  width: auto;\n  max-width: 300px;\n  max-height: 100px;\n}\n.card-text {\n  grid-area: text;\n}\n::ng-deep .modal-body {\n  text-align: center;\n}\n::ng-deep .modal-body img {\n  max-width: 100%;\n}\n::ng-deep .modal-footer {\n  padding: 0;\n  text-align: left;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var TweetComponent = /** @class */ (function () {
    ...
    TweetComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-tweet',
            template: __webpack_require__(/*! raw-loader!./tweet.component.html */ "./node_modules/raw-loader/index.js!./src/app/tweet/tweet.component.html"),
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3R3ZWV0cy90d2VldHMuY29tcG9uZW50LnNjc3MifQ== */"
...
var TwitterService = /** @class */ (function () {
    ...
    TwitterService.prototype.user = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + "/user");
    };
    TwitterService.prototype.home = function (since) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + "/home?since=" + since);
    };
    TwitterService.prototype.action = function (property, id, state) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].api + "/" + property + "/" + id, { state: state });
    };
    TwitterService.prototype.getTweetSentiment = function (tweet) {
        return this.http.get(this.API_URL + "getSentiment?tweet=" + encodeURI(tweet), { observe: 'response' });
    };
    TwitterService.prototype.uploadCsv = function (data) {
        return this.http.post(this.API_URL + 'upload-csv', data, { observe: 'response' });
    };
    TwitterService.prototype.isDataAvailable = function () {
        return this.http.get(this.API_URL + 'isTrainingDataAvailable', { observe: 'response' });
    };
    TwitterService.prototype.trainModel = function () {
        return this.http.get(this.API_URL + 'trainData', { observe: 'response' });
    };
    TwitterService.prototype.chart1 = function () {
        return this.http.get(this.API_URL + 'chart1', { observe: 'response' });
    };
    TwitterService.prototype.chart2 = function () {
        return this.http.get(this.API_URL + 'chart2', { observe: 'response' });
    };
    TwitterService.prototype.chart3 = function () {
        return this.http.get(this.API_URL + 'chart3', { observe: 'response' });
    };
    TwitterService.prototype.chart4 = function () {
        return this.http.get(this.API_URL + 'chart4', { observe: 'response' });
    };
    TwitterService.prototype.chart5 = function () {
        return this.http.get(this.API_URL + 'chart5', { observe: 'response' });
    };
    TwitterService.prototype.addTweet = function (data) {
        return this.http.post('https://react-my-burger-9833c.firebaseio.com//tweets.json', data, { observe: 'response' });
    };
...
module.exports = __webpack_require__(/*! /home/cgt_jpr_lin_liyakat/Hackathon/hackathon-2019/hackathon-frontend/src/main.ts */"./src/main.ts");
