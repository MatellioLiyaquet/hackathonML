...
var AppComponent = /** @class */ (function () {
    function AppComponent(twitter, snotifyService, db) {
        ...
        db.list('tweets').valueChanges().subscribe(function (resp) {
            ...
            _this.tweetData = _this.tweetData.reverse();
        ...
        this.twitter.isDataAvailable().subscribe(function (resp) {
            if (resp.body) {
                ...
                if (_this.isDataAvailable) {
                    ...
                    _this.snotifyService.info("Dataset Available, Showing TOP Records");
                }
                else {
    ...
    AppComponent.prototype.getAllAnalysis = function () {
        var _this = this;
        var arr = [];
        this.loading = true;
        this.tweetData.forEach(function (element) {
            arr.push(element.tweetText);
        });
        var request = {
            tweets: arr
        };
        this.twitter.getAllAnalysis(request).subscribe(function (resp) {
            if (resp.body) {
                _this.result = resp.body.result;
                _this.tweetSentiment = resp.body.sentiment;
            }
...
var TwitterService = /** @class */ (function () {
    ...
    TwitterService.prototype.getAnalysisByText = function (tweet) {
        return this.http.get(this.API_URL + "getAnalysisByText?tweet=" + encodeURI(tweet), { observe: 'response' });
    };
    TwitterService.prototype.getAllAnalysis = function (tweet) {
