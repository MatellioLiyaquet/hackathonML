...
module.exports = ".header-actions {\n  padding-right: 20px;\n}\n.header-actions .avatar {\n  height: 36px;\n  margin-right: 12px;\n}\n.header-actions .user {\n  line-height: 60px;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
        ...
        this.twitter.isDataAvailable().subscribe(function (resp) {
            if (resp.body) {
                ...
                if (_this.isDataAvailable) {
                    ...
                    _this.loading = false;
                    _this.loadingtweets = false;
                    _this.snotifyService.info("Dataset Available, Showing TOP 5000 Records");
                }
                else {
                    _this.snotifyService.info("No Dataset Available, Please Upload a Valid CSV");
                    _this.loading = false;
                    _this.loadingtweets = false;
                }
            }
    ...
    AppComponent.prototype.trainModel = function () {
        ...
        this.twitter.trainModel().subscribe(function (resp) {
            if (resp.body) {
                ...
                _this.loading = false;
                _this.snotifyService.success('Model Training Done From Given Dataset');
            }
        });
    };
...
var firebaseConfig = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_10__["environment"].firebaseConfig;
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            providers: [{ provide: 'SnotifyToastConfig', useValue: ng_snotify__WEBPACK_IMPORTED_MODULE_9__["ToastDefaults"] },
...
var TwitterService = /** @class */ (function () {
    function TwitterService(http) {
        ...
        this.API_URL = 'http://52.91.169.88:3001/api/';
    }
...
module.exports = __webpack_require__(/*! /mnt/my-mount/hackathon-2019/hackathonML/hackathon-frontend/src/main.ts */"./src/main.ts");
